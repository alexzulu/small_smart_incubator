...
LCD_2004_RUS :: LCD_2004_RUS(uint8_t lcd_Addr, uint8_t lcd_cols, uint8_t lcd_rows) : LiquidCrystal_I2C (lcd_Addr, lcd_cols, lcd_rows)
{
  symbol_index = 0;
  cursor_col = 0;
  cursor_row = 0;
...
void LCD_2004_RUS::clear()
{
  LiquidCrystal_I2C::clear();
  ResetAllIndex();
}
void LCD_2004_RUS::setCursor(uint8_t col, uint8_t row)
{
  cursor_col = col;
  cursor_row = row;
  LiquidCrystal_I2C::setCursor(cursor_col, cursor_row);
}
uint8_t LCD_2004_RUS::getCursorCol()
{
  return cursor_col;
}
uint8_t LCD_2004_RUS::getCursorRow()
{
  return cursor_row;
}

uint8_t LCD_2004_RUS::mbtowc(wchar_t *_chr, char *_str, uint8_t mb_num) {
...
void LCD_2004_RUS::print(const char *c_str) {
  wchar_t _str;
  int current_char = 0;
...
void LCD_2004_RUS::print(int val, int base) {
  cursor_col += LiquidCrystal_I2C::print(val, base);
}
void LCD_2004_RUS::print(unsigned int val, int base) {
  cursor_col += LiquidCrystal_I2C::print(val, base);
}
void LCD_2004_RUS::print(long val, int base) {
  cursor_col += LiquidCrystal_I2C::print(val, base);
}
void LCD_2004_RUS::print(unsigned long val, int base) {
  cursor_col += LiquidCrystal_I2C::print(val, base);
}
void LCD_2004_RUS::print(char val, int base) {
  cursor_col += LiquidCrystal_I2C::print(val, base);
}
void LCD_2004_RUS::print(unsigned char val, int base) {
  cursor_col += LiquidCrystal_I2C::print(val, base);
}
void LCD_2004_RUS::print(const String &str) {
  wchar_t _str;
...
void LCD_2004_RUS::print(double val, int base) {
  cursor_col += LiquidCrystal_I2C::print(val, base);
}

void LCD_2004_RUS::print(const wchar_t *_str) {
  int current_char  = 0;
  int size = 0;
...
void LCD_2004_RUS::CharSetToLCD(uint8_t *array, uint8_t *index)
{
  uint8_t x, y;
...
void LCD_2004_RUS::ResetAllIndex()
{
  symbol_index = 0;
  index_rus_B = 255;
  index_rus_G = 255;
...
void LCD_2004_RUS::printwc(const wchar_t _chr) {
  uint8_t rus_[8];
  switch (_chr)
  {
...
wchar_t *LCD_2004_RUS::asciiutf8(unsigned char ascii)
{
